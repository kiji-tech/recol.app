        ...
        {highlight && (
          <View className="mt-2 flex items-start justify-center">
            <Text className="p-2 text-xs text-light-primary dark:text-dark-primary bg-light-primary/20 dark:bg-dark-primary/20 rounded-full">
              {generateI18nMessage('COMPONENT.PAYMENT.RECOMMENDED')}
            </Text>
          </View>
        )}
      </View>
      ...
      <View className="bg-light-primary dark:bg-dark-primary">
        <View className="flex flex-row justify-between">
          <Text className="p-4 flex-1 self-center text-center text-white font-bold text-lg">
            {generateI18nMessage('COMPONENT.PAYMENT.FEATURE')}
          </Text>
          <View className="p-4 w-32 self-center">
            <Text className="text-center text-white font-bold">
              {generateI18nMessage('COMPONENT.PAYMENT.FREE')}
            </Text>
          </View>
          <View className="p-4 w-40 self-center">
            ...
            <Text className="text-center text-white/80 text-xs">
              {generateI18nMessage('COMPONENT.PAYMENT.ALL_FEATURES')}
            </Text>
          </View>
        </View>
      </View>
      <PlanItem
        title={generateI18nMessage('COMPONENT.PAYMENT.MEDIA_CAPACITY')}
        free={generateI18nMessage('COMPONENT.PAYMENT.MEDIA_CAPACITY_FREE')}
        premium={generateI18nMessage('COMPONENT.PAYMENT.MEDIA_CAPACITY_PREMIUM')}
      />
      <PlanItem
        title={generateI18nMessage('COMPONENT.PAYMENT.RATE_LIMIT')}
        free={generateI18nMessage('COMPONENT.PAYMENT.RATE_LIMIT_FREE')}
        premium={generateI18nMessage('COMPONENT.PAYMENT.RATE_LIMIT_PREMIUM')}
      />
      <PlanItem
        title={generateI18nMessage('COMPONENT.PAYMENT.AD_DISPLAY')}
        free={generateI18nMessage('COMPONENT.PAYMENT.YES')}
        premium={generateI18nMessage('COMPONENT.PAYMENT.NO')}
      />
